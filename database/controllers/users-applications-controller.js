...
//   try {
//     const { first_name, middle_name, last_name, user_type, email, password, student_number } = req.body;
...
//   } catch (error) {
//     console.error(error);
//     res.status(500).json({ success: false, error: "An error occurred while adding the approver." });
//   }
// };
...
//     const editedApprover = await User.findOneAndUpdate({ approver }, { $set: edited_approver_data }, { new: true });
